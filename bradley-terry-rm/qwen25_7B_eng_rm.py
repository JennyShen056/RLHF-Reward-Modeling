...
class ScriptArguments:
    ...
    model_name: Optional[str] = field(
        default="Jennny/qwen25_7b_sft_eng_math",
        metadata={
    ...
    output_path: Optional[str] = field(
        default="./models/qwen25_math_eng_rm",
    ...
    hub_repo_name: Optional[str] = field(
        default="qwen25_math_eng_rm", metadata={"help": "Hub repository name"}
    )
